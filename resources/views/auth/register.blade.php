            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Nama Belakang</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="jk" id="Laki-Laki" class="with-gap" value="Laki-Laki">
                                <label for="Laki-Laki">Laki-Laki</label>
                                <br>
                                <input type="radio" name="jk" id="Perempuan" class="with-gap" value="Perempuan">
